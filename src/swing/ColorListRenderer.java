...
//			System.out.println("Selected" + selectedIndex);
			...
			Color c = paleta.getColores().get(selectedIndex);
			int limit = paleta.getValores().get(selectedIndex);
			
			asistente.setMuestra(c.getRed(), c.getGreen(), c.getBlue(), limit);
		} else {
		...
		// Setear maximo
		setText("" + valores.get(selectedIndex));
		// Setear color de muestra
		ImageIcon icon = new ImageIcon(new ImgMuestra(colores.get(selectedIndex)));
		setIcon(icon);
		return this;
	}
